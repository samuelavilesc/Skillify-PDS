...
public class CourseExecutionWindow extends JFrame {
	...
	private void mostrarPregunta() {
		...
		SwingUtilities.invokeLater(() -> {
			JOptionPane.showMessageDialog(this, "Has completado todas las preguntas.", "Curso Finalizado",
	...
	private void procesarRespuesta(ActionEvent e) {
		...
		if (question instanceof MultipleChoiceQuestion) {
			...
			if (optionsGroup.getSelection() != null) {
				...
				if (!esCorrecto) {
					...
					if (course.getMode() == CourseMode.REPETITION) {
						JOptionPane.showMessageDialog(this, "Respuesta incorrecta. Inténtalo de nuevo.", "Incorrecto",
			...
			if (esCorrecto) {
				JOptionPane.showMessageDialog(this, "¡Respuesta correcta!", "Correcto",
						JOptionPane.INFORMATION_MESSAGE);
				currentQuestionIndex++;
				mostrarPregunta();
			} else {
