...
public class RegisterWindow extends JFrame {
    ...
    private void initialize() {
        ...
        genericAvatarLabel.setIcon(new ImageIcon(selectedAvatar.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))); // Imagen más pequeña
    ...
    public void setAvatar(ImageIcon avatar) {
        ...
        genericAvatarLabel.setIcon(new ImageIcon(avatar.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))); // Imagen más pequeña
    }
