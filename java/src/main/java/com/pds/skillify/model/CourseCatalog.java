...
public class CourseCatalog {
	...
	/**
	 * Constructor privado para el patrón Singleton. Carga los cursos desde la base
	 * de datos.
	 */
	...
	public Course getCourse(Long id) {
		return courses.values().stream().filter(c -> c.getId().equals(id)).findAny().orElse(null);
	}
