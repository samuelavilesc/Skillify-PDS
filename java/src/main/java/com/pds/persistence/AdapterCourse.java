...
public class AdapterCourse implements CourseDAO {
    ...
    public Course getCourseById(Long id) {
        ...
        Course course = em.createQuery(
            "SELECT c FROM Course c LEFT JOIN FETCH c.questions WHERE c.id = :id", Course.class)
            .setParameter("id", id)
            .getSingleResult();
        em.close();
        return course;
    ...
    public List<Course> getAllCourses() {
        ...
        List<Course> courses = em.createQuery(
            "SELECT c FROM Course c LEFT JOIN FETCH c.questions", Course.class)
            .getResultList();
        em.close();
        return courses;
    }
    ...
    public Course getCourseByName(String name) {
        ...
        try {
            course = em.createQuery(
                "SELECT c FROM Course c LEFT JOIN FETCH c.questions WHERE c.name = :name", Course.class)
